...
public class MonitorServiceImpl implements MonitorService {
    ...
    public Map<String, Object> getServers() {
        ...
        try {
            ...
            map.put("sys", getSystemInfo(os));
            map.put("cpu", getCpuInfo(hardwareAbstractionLayer.getProcessor()));
            map.put("memory", getMemoryInfo(hardwareAbstractionLayer.getMemory()));
            map.put("swap", getSwapInfo(hardwareAbstractionLayer.getMemory()));
    ...
    private Map<String, Object> getSystemInfo(OperatingSystem os) {
        Map<String, Object> systemInfo = new LinkedHashMap<>(3);
    ...
    private Map<String, Object> getCpuInfo(CentralProcessor processor) {
        Map<String, Object> cpuInfo = new LinkedHashMap<>(7);
        ...
        cpuInfo.put("logic", processor.getLogicalProcessorCount() + "个罗技CPU");
        // CPU信息
